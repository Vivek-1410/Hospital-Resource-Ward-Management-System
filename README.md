...
Real-time bed and ward availability tracking

Equipment and resource inventory management

Staff assignment to wards and shifts

Administrative dashboard with occupancy statistics
...
System successfully handles all admission, transfer, and discharge workflows

At least 80% of users can perform core tasks without external assistance

Real-time resource availability reflects accurate data

No unauthorized access due to effective role-based control

Stable performance during a continuous 30-day test period

Completion within the defined scope and timeline

⚙️ Assumptions

Users have access to a web browser on desktop or mobile devices

Hospital staff are willing to transition from manual systems to a digital platform

Internet connectivity is available within hospital premises

The development team has access to open-source development tools

⛔ Constraints

Project must be completed within a 3-month development timeline

Only free and open-source technologies will be used

Development team consists of students with basic to intermediate skills

Interface must remain simple for non-technical users
